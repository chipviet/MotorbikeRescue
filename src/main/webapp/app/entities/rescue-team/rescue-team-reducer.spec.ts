...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RESCUETEAM_LIST actions', async () => {
    ...
    it('dispatches FETCH_RESCUETEAM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_RESCUETEAM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_RESCUETEAM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_RESCUETEAM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_RESCUETEAM actions', async () => {
      const expectedActions = [
        {
