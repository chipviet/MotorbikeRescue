...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CONNECTION_LIST actions', async () => {
    ...
    it('dispatches FETCH_CONNECTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CONNECTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CONNECTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CONNECTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CONNECTION actions', async () => {
      const expectedActions = [
        {
