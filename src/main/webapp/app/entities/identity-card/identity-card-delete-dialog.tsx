...
import { getEntity, deleteEntity } from './identity-card.reducer';

export const IdentityCardDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="mrProjectApp.identityCard.delete.question">
        <Translate contentKey="mrProjectApp.identityCard.delete.question" interpolate={{ id: identityCardEntity.id }}>
...
export default IdentityCardDeleteDialog;
