...
import com.chipviet.project.security.*;
import com.chipviet.project.security.jwt.*;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    public void configure(HttpSecurity http) throws Exception {
        ...
        .and()
            ...
            .antMatchers("/api/v1/push-notification/specific-user").permitAll()
            .antMatchers("/api/phoneNumber/**").permitAll()
            .antMatchers("/api/register/repairer").permitAll()
