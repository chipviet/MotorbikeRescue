...
export class DeviceDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('mrProjectApp.device.delete.question'));
...
export default class DeviceComponentsPage {
  ...
  async deleteDevice() {
    ...
    expect(await deviceDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/mrProjectApp.device.delete.question/);
