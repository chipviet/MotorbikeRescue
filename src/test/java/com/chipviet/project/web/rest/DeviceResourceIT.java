...
class DeviceResourceIT {
    ...
    public static Device createEntity(EntityManager em) {
        Device device = new Device().name(DEFAULT_NAME).deviceUuid(DEFAULT_DEVICE_UUID).platform(DEFAULT_PLATFORM).version(DEFAULT_VERSION);
        return device;
    }
    ...
    public static Device createUpdatedEntity(EntityManager em) {
        Device device = new Device().name(UPDATED_NAME).deviceUuid(UPDATED_DEVICE_UUID).platform(UPDATED_PLATFORM).version(UPDATED_VERSION);
        return device;
    }
    ...
    void createDevice() throws Exception {
        ...
        assertThat(testDevice.getPlatform()).isEqualTo(DEFAULT_PLATFORM);
    ...
    void putNewDevice() throws Exception {
        ...
        updatedDevice.name(UPDATED_NAME).deviceUuid(UPDATED_DEVICE_UUID).platform(UPDATED_PLATFORM).version(UPDATED_VERSION);
        ...
        assertThat(testDevice.getPlatform()).isEqualTo(UPDATED_PLATFORM);
    ...
    void partialUpdateDeviceWithPatch() throws Exception {
        ...
        partialUpdatedDevice.version(UPDATED_VERSION);
    ...
    void fullUpdateDeviceWithPatch() throws Exception {
        ...
        partialUpdatedDevice.name(UPDATED_NAME).deviceUuid(UPDATED_DEVICE_UUID).platform(UPDATED_PLATFORM).version(UPDATED_VERSION);
