...
import com.chipviet.project.repository.RatingRepository;
...
class RatingResourceIT {
    ...
    public static Rating createEntity(EntityManager em) {
        Rating rating = new Rating().star(DEFAULT_STAR).comment(DEFAULT_COMMENT).createAt(DEFAULT_CREATE_AT);
        return rating;
    }
    ...
    public static Rating createUpdatedEntity(EntityManager em) {
        Rating rating = new Rating().star(UPDATED_STAR).comment(UPDATED_COMMENT).createAt(UPDATED_CREATE_AT);
        return rating;
    }
    ...
    void createRating() throws Exception {
        ...
        assertThat(testRating.getCreateAt()).isEqualTo(DEFAULT_CREATE_AT);
    }
    ...
    void putNewRating() throws Exception {
        ...
        updatedRating.star(UPDATED_STAR).comment(UPDATED_COMMENT).createAt(UPDATED_CREATE_AT);
        ...
        assertThat(testRating.getCreateAt()).isEqualTo(UPDATED_CREATE_AT);
    }
    ...
    void partialUpdateRatingWithPatch() throws Exception {
        ...
        partialUpdatedRating.star(UPDATED_STAR).comment(UPDATED_COMMENT);
    ...
    void fullUpdateRatingWithPatch() throws Exception {
        ...
        partialUpdatedRating.star(UPDATED_STAR).comment(UPDATED_COMMENT).createAt(UPDATED_CREATE_AT);
